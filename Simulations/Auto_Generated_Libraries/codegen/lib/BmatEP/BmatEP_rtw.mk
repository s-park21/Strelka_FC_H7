###########################################################################
## Makefile generated for component 'BmatEP'. 
## 
## Makefile     : BmatEP_rtw.mk
## Generated on : Sat May 11 15:06:44 2024
## Final product: ./BmatEP.lib
...
COMPILER_COMMAND_FILE     = BmatEP_rtw_comp.rsp
CMD_FILE                  = BmatEP_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = BmatEP.lib
...
DEFINES_STANDARD = -DMODEL=BmatEP
...
SRCS = $(START_DIR)/codegen/lib/BmatEP/BmatEP_initialize.c $(START_DIR)/codegen/lib/BmatEP/BmatEP_terminate.c $(START_DIR)/codegen/lib/BmatEP/BmatEP.c
...
OBJS = BmatEP_initialize.o BmatEP_terminate.o BmatEP.o
...
%.o : $(START_DIR)/codegen/lib/BmatEP/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/BmatEP/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/BmatEP/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/BmatEP/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/BmatEP/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
BmatEP_initialize.o : $(START_DIR)/codegen/lib/BmatEP/BmatEP_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BmatEP_terminate.o : $(START_DIR)/codegen/lib/BmatEP/BmatEP_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BmatEP.o : $(START_DIR)/codegen/lib/BmatEP/BmatEP.c
	$(CC) $(CFLAGS) -o "$@" "$<"
