...
const osSemaphoreAttr_t SPI4Semaphore_attributes = {
  .name = "SPI4Semaphore",
  .cb_mem = &SPI4SemaphoreControlBlock,
  .cb_size = sizeof(SPI4SemaphoreControlBlock),
};
...
stream_packet_config_set packet_streamer = { .stream_packet_type_enabled = 0, .packet_stream_frequency = 0.5 };
...
//	TxHeader1.Identifier = 0x001;			// This number defines the CAN ID of this device when transmitting
...
//		TxData1[1] = 0xAA;
		// Implement correctly ************
//		if (HAL_FDCAN_IsTxBufferMessagePending(&hfdcan1, 1)) {
//			// Message failed to send. Abort to
