###########################################################################
## Makefile generated for component 'EP2C'. 
## 
## Makefile     : EP2C_rtw.mk
## Generated on : Sat May 11 14:40:36 2024
## Final product: ./EP2C.lib
...
COMPILER_COMMAND_FILE     = EP2C_rtw_comp.rsp
CMD_FILE                  = EP2C_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = EP2C.lib
...
SRCS = $(START_DIR)/codegen/lib/EP2C/EP2C_initialize.c $(START_DIR)/codegen/lib/EP2C/EP2C_terminate.c $(START_DIR)/codegen/lib/EP2C/EP2C.c
...
OBJS = EP2C_initialize.o EP2C_terminate.o EP2C.o
...
%.o : $(START_DIR)/codegen/lib/EP2C/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/EP2C/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/EP2C/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/EP2C/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/EP2C/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
EP2C_initialize.o : $(START_DIR)/codegen/lib/EP2C/EP2C_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


EP2C_terminate.o : $(START_DIR)/codegen/lib/EP2C/EP2C_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


EP2C.o : $(START_DIR)/codegen/lib/EP2C/EP2C.c
	$(CC) $(CFLAGS) -o "$@" "$<"
