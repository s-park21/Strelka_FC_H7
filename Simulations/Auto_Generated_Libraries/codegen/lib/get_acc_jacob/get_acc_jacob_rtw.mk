###########################################################################
## Makefile generated for component 'get_acc_jacob'. 
## 
## Makefile     : get_acc_jacob_rtw.mk
## Generated on : Sat May 11 14:18:13 2024
## Final product: ./get_acc_jacob.lib
...
PRODUCT_NAME              = get_acc_jacob
MAKEFILE                  = get_acc_jacob_rtw.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/thean/OneDrive/DOCUME~1/OTHERP~1/HOVERD~1/ST5CF5~1/SIMULA~1/AUTO_G~1
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = ../../..
COMPILER_COMMAND_FILE     = get_acc_jacob_rtw_comp.rsp
CMD_FILE                  = get_acc_jacob_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = get_acc_jacob.lib
...
DEFINES_STANDARD = -DMODEL=get_acc_jacob
...
SRCS = $(START_DIR)/codegen/lib/get_acc_jacob/rt_nonfinite.c $(START_DIR)/codegen/lib/get_acc_jacob/rtGetNaN.c $(START_DIR)/codegen/lib/get_acc_jacob/rtGetInf.c $(START_DIR)/codegen/lib/get_acc_jacob/get_acc_jacob_initialize.c $(START_DIR)/codegen/lib/get_acc_jacob/get_acc_jacob_terminate.c $(START_DIR)/codegen/lib/get_acc_jacob/get_acc_jacob.c $(START_DIR)/codegen/lib/get_acc_jacob/get_gyro_jacob.c $(START_DIR)/codegen/lib/get_acc_jacob/get_mag_jacob.c
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o get_acc_jacob_initialize.o get_acc_jacob_terminate.o get_acc_jacob.o get_gyro_jacob.o get_mag_jacob.o
...
%.o : $(START_DIR)/codegen/lib/get_acc_jacob/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/get_acc_jacob/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/get_acc_jacob/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/get_acc_jacob/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/get_acc_jacob/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_nonfinite.o : $(START_DIR)/codegen/lib/get_acc_jacob/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/codegen/lib/get_acc_jacob/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/codegen/lib/get_acc_jacob/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


get_acc_jacob_initialize.o : $(START_DIR)/codegen/lib/get_acc_jacob/get_acc_jacob_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


get_acc_jacob_terminate.o : $(START_DIR)/codegen/lib/get_acc_jacob/get_acc_jacob_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


get_acc_jacob.o : $(START_DIR)/codegen/lib/get_acc_jacob/get_acc_jacob.c
	$(CC) $(CFLAGS) -o "$@" "$<"


get_gyro_jacob.o : $(START_DIR)/codegen/lib/get_acc_jacob/get_gyro_jacob.c
	$(CC) $(CFLAGS) -o "$@" "$<"


get_mag_jacob.o : $(START_DIR)/codegen/lib/get_acc_jacob/get_mag_jacob.c
	$(CC) $(CFLAGS) -o "$@" "$<"
